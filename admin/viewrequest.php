...
<body>
<p style="text-align:center;font-size:60px;font-family:sans-serif;color:black;background-color: grey;color: white; border-radius:0.5px">Blood Bank Management System</p>
 ...
 <center>
  ...
  <a href="adminhome.php"style="color:black;font-size: 20px;" class="btn btn-primary">Back to home</a>
 	 <h3 style="color:black;font-size: 20px">Copyright@2022 Online Blood Management System</h3>
