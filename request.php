...
?>
  ...
  <h2 style="background-color: grey; color: white">Send Blood Request</h2>
                ...
                {?> 
                    ...
                    <input type="date" name="bloodtime" id="bloodtime">
                    <div class="required"></div>
<br>
                    <input style="background-color: dark; color: white" type="submit" value="Request" name="request">
                </form>
                <?php 
                  }
                  ?>
