...
<b><i>Hi,Welcome to our Online Blood Bank Management System Website.</b></i>
</marquee>
    <section>
 <br>
  <div id="myCarousel" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        ...
        <img src="images/kushal.jpg" alt="Chania" width="460" height="345">
        <p></p>
      </div>
    ...
    <div class="container">
        <div class="col-md-8 main-section">
            <h2>Our Mission</h2>
            <p>Our mission is to provide an interface for users to 
                donate blood as per their choice and search for blood 
                as per their needs through this portal or 
                blood management system website.
                This website will be able to fulfill
                all the users demand and make them easy
                to search for the required pints of bloods
                to save someone's life.
            </p>
            <div class="note">
                <strong>The blood you donate might be a variable asset to someone's life.</strong>
            </div>
            <div class="spacer"></div>
        </div>
        <div class="col-md-4">
           <div class="sidebar">
               <img src="images/save.jpg" width="460" height="345" alt="Blood Donation"/>
           </div>
        </div>
    </div>
