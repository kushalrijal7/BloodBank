...
<p style="text-align:center;font-size:60px;font-family:sans-serif;color:black;border-radius:0.5px; background-color: grey;color: white;">Blood Bank Management System</p>
 ...
 <center>
 	<br>
 	<br>
 	 <h3 style="color:black;font-size: 20px">Copyright@2022 Blood Blood Management System</h3>
