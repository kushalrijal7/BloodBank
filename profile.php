...
<nav class="navbar navbar-inverse" style="background-color: grey; color: white">
  <div class="container-fluid">
    <div class="navbar-header">
      <a style="background-color: grey; color: white" class="navbar-brand" href="#">Welcome <?php echo($_SESSION['user']);?></a>
    </div>
    <div >
      <ul class="nav navbar-nav" >
       
        <li><a data-toggle="modal" style="background-color: grey; color: white" href="#myModal">Donate Now</a></li>
